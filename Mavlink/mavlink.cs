...
{
    public const string MAVLINK_BUILD_DATE = "Tue Nov 28 2023";
    ...
    public static message_info[] MAVLINK_MESSAGE_INFOS = new message_info[] {
        ...
        new message_info(150, "SENSOR_OFFSETS", 134, 42, 42, typeof( mavlink_sensor_offsets_t )), // none 24 bit
        new message_info(151, "SET_MAG_OFFSETS", 219, 8, 8, typeof( mavlink_set_mag_offsets_t )), // none 24 bit
        new message_info(152, "MEMINFO", 208, 4, 4, typeof( mavlink_meminfo_t )), // none 24 bit
        new message_info(153, "AP_ADC", 188, 12, 12, typeof( mavlink_ap_adc_t )), // none 24 bit
        new message_info(154, "DIGICAM_CONFIGURE", 84, 15, 15, typeof( mavlink_digicam_configure_t )), // none 24 bit
        new message_info(155, "DIGICAM_CONTROL", 22, 13, 13, typeof( mavlink_digicam_control_t )), // none 24 bit
        new message_info(156, "MOUNT_CONFIGURE", 19, 6, 6, typeof( mavlink_mount_configure_t )), // none 24 bit
        new message_info(157, "MOUNT_CONTROL", 21, 15, 15, typeof( mavlink_mount_control_t )), // none 24 bit
        new message_info(158, "MOUNT_STATUS", 134, 14, 14, typeof( mavlink_mount_status_t )), // none 24 bit
        new message_info(160, "FENCE_POINT", 78, 12, 12, typeof( mavlink_fence_point_t )), // none 24 bit
        new message_info(161, "FENCE_FETCH_POINT", 68, 3, 3, typeof( mavlink_fence_fetch_point_t )), // none 24 bit
        new message_info(162, "FENCE_STATUS", 189, 8, 8, typeof( mavlink_fence_status_t )), // none 24 bit
        new message_info(163, "AHRS", 127, 28, 28, typeof( mavlink_ahrs_t )), // none 24 bit
        new message_info(164, "SIMSTATE", 154, 44, 44, typeof( mavlink_simstate_t )), // none 24 bit
        new message_info(165, "HWSTATUS", 21, 3, 3, typeof( mavlink_hwstatus_t )), // none 24 bit
        new message_info(166, "RADIO", 21, 9, 9, typeof( mavlink_radio_t )), // none 24 bit
        new message_info(167, "LIMITS_STATUS", 144, 22, 22, typeof( mavlink_limits_status_t )), // none 24 bit
        new message_info(168, "WIND", 1, 12, 12, typeof( mavlink_wind_t )), // none 24 bit
        new message_info(169, "DATA16", 234, 18, 18, typeof( mavlink_data16_t )), // none 24 bit
        new message_info(170, "DATA32", 73, 34, 34, typeof( mavlink_data32_t )), // none 24 bit
        new message_info(171, "DATA64", 181, 66, 66, typeof( mavlink_data64_t )), // none 24 bit
        new message_info(172, "DATA96", 22, 98, 98, typeof( mavlink_data96_t )), // none 24 bit
        new message_info(173, "RANGEFINDER", 83, 8, 8, typeof( mavlink_rangefinder_t )), // none 24 bit
        new message_info(174, "AIRSPEED_AUTOCAL", 167, 48, 48, typeof( mavlink_airspeed_autocal_t )), // none 24 bit
        new message_info(175, "RALLY_POINT", 138, 19, 19, typeof( mavlink_rally_point_t )), // none 24 bit
        new message_info(176, "RALLY_FETCH_POINT", 234, 3, 3, typeof( mavlink_rally_fetch_point_t )), // none 24 bit
        new message_info(177, "COMPASSMOT_STATUS", 240, 20, 20, typeof( mavlink_compassmot_status_t )), // none 24 bit
        new message_info(178, "AHRS2", 47, 24, 24, typeof( mavlink_ahrs2_t )), // none 24 bit
        new message_info(179, "CAMERA_STATUS", 189, 29, 29, typeof( mavlink_camera_status_t )), // none 24 bit
        new message_info(180, "CAMERA_FEEDBACK", 52, 45, 45, typeof( mavlink_camera_feedback_t )), // none 24 bit
        new message_info(181, "BATTERY2", 174, 4, 4, typeof( mavlink_battery2_t )), // none 24 bit
        new message_info(182, "AHRS3", 229, 40, 40, typeof( mavlink_ahrs3_t )), // none 24 bit
        new message_info(183, "AUTOPILOT_VERSION_REQUEST", 85, 2, 2, typeof( mavlink_autopilot_version_request_t )), // none 24 bit
        new message_info(184, "REMOTE_LOG_DATA_BLOCK", 159, 206, 206, typeof( mavlink_remote_log_data_block_t )), // none 24 bit
        new message_info(185, "REMOTE_LOG_BLOCK_STATUS", 186, 7, 7, typeof( mavlink_remote_log_block_status_t )), // none 24 bit
        new message_info(186, "LED_CONTROL", 72, 29, 29, typeof( mavlink_led_control_t )), // none 24 bit
        new message_info(191, "MAG_CAL_PROGRESS", 92, 27, 27, typeof( mavlink_mag_cal_progress_t )), // none 24 bit
        new message_info(192, "MAG_CAL_REPORT", 36, 44, 44, typeof( mavlink_mag_cal_report_t )), // none 24 bit
        new message_info(193, "EKF_STATUS_REPORT", 71, 22, 22, typeof( mavlink_ekf_status_report_t )), // none 24 bit
        new message_info(194, "PID_TUNING", 98, 25, 25, typeof( mavlink_pid_tuning_t )), // none 24 bit
        new message_info(195, "DEEPSTALL", 120, 37, 37, typeof( mavlink_deepstall_t )), // none 24 bit
        new message_info(200, "GIMBAL_REPORT", 134, 42, 42, typeof( mavlink_gimbal_report_t )), // none 24 bit
        new message_info(201, "GIMBAL_CONTROL", 205, 14, 14, typeof( mavlink_gimbal_control_t )), // none 24 bit
        new message_info(214, "GIMBAL_TORQUE_CMD_REPORT", 69, 8, 8, typeof( mavlink_gimbal_torque_cmd_report_t )), // none 24 bit
        new message_info(215, "GOPRO_HEARTBEAT", 101, 3, 3, typeof( mavlink_gopro_heartbeat_t )), // none 24 bit
        new message_info(216, "GOPRO_GET_REQUEST", 50, 3, 3, typeof( mavlink_gopro_get_request_t )), // none 24 bit
        new message_info(217, "GOPRO_GET_RESPONSE", 202, 6, 6, typeof( mavlink_gopro_get_response_t )), // none 24 bit
        new message_info(218, "GOPRO_SET_REQUEST", 17, 7, 7, typeof( mavlink_gopro_set_request_t )), // none 24 bit
        new message_info(219, "GOPRO_SET_RESPONSE", 162, 2, 2, typeof( mavlink_gopro_set_response_t )), // none 24 bit
        new message_info(225, "EFI_STATUS", 208, 65, 65, typeof( mavlink_efi_status_t )), // none 24 bit
        new message_info(226, "RPM", 207, 8, 8, typeof( mavlink_rpm_t )), // none 24 bit
    ...
    public enum MAV_CMD: ushort
    {
        ...
        ///<summary> Starts video capture (recording). |Video Stream ID (0 for all streams)| Frequency CAMERA_CAPTURE_STATUS messages should be sent while recording (0 for no messages, otherwise frequency)| Reserved (default:NaN)| Reserved (default:NaN)| Reserved (default:0)| Reserved (default:0)| Reserved (default:NaN)|  </summary>
        [Description("Starts video capture (recording).")]
        VIDEO_START_CAPTURE=2500, 
        ///<summary> Stop the current video capture (recording). |Video Stream ID (0 for all streams)| Reserved (default:NaN)| Reserved (default:NaN)| Reserved (default:NaN)| Reserved (default:0)| Reserved (default:0)| Reserved (default:NaN)|  </summary>
    ...
    public enum SCRIPTING_CMD: int /*default*/
    {
        ...
        REPL_STOP=1, 
        ///<summary> Stop execution of scripts. | </summary>
        [Description("Stop execution of scripts.")]
        STOP=2, 
        ///<summary> Stop execution of scripts and restart. | </summary>
        [Description("Stop execution of scripts and restart.")]
        STOP_AND_RESTART=3, 
    ...
    ///<summary>  </summary>
    public enum MAV_CMD_DO_AUX_FUNCTION_SWITCH_LEVEL: int /*default*/
    {
        ///<summary> Switch Low. |Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  </summary>
        [Description("Switch Low.")]
        LOW=0, 
        ///<summary> Switch Middle. |Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  </summary>
        [Description("Switch Middle.")]
        MIDDLE=1, 
        ///<summary> Switch High. |Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)| Reserved (default:0)|  </summary>
        [Description("Switch High.")]
        HIGH=2, 
    ...
    public enum DEVICE_OP_BUSTYPE: int /*default*/
    {
    ...
    public enum OSD_PARAM_CONFIG_TYPE: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
        OSD_PARAM_NONE=0, 
    ...
    public enum OSD_PARAM_CONFIG_ERROR: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
        OSD_PARAM_SUCCESS=0, 
    ...
    public enum UAVIONIX_ADSB_OUT_DYNAMIC_STATE: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
        INTENT_CHANGE=1, 
    ...
    public enum UAVIONIX_ADSB_OUT_RF_SELECT: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
        STANDBY=0, 
    ...
    public enum UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
        NONE_0=0, 
    ...
    public enum UAVIONIX_ADSB_RF_HEALTH: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
        INITIALIZING=0, 
    ...
    public enum UAVIONIX_ADSB_OUT_CFG_AIRCRAFT_SIZE: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
        NO_DATA=0, 
    ...
    public enum UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LAT: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
        NO_DATA=0, 
    ...
    public enum UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LON: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
        NO_DATA=0, 
    ...
    public enum UAVIONIX_ADSB_EMERGENCY_STATUS: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
    ...
    ///<summary>  </summary>
    public enum ICAROUS_TRACK_BAND_TYPES: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
    ...
    ///<summary>  </summary>
    public enum ICAROUS_FMS_STATE: int /*default*/
    {
        ///<summary>  | </summary>
        [Description("")]
        IDLE=0, 
    ...
    ///<summary>  </summary>
    public enum AIRLINK_AUTH_RESPONSE_TYPE: int /*default*/
    {
    ...
    {
        public mavlink_meminfo_t(ushort brkval,ushort freemem) 
        {
              this.brkval = brkval;
    ...
    {
        public mavlink_camera_feedback_t(ulong time_usec,int lat,int lng,float alt_msl,float alt_rel,float roll,float pitch,float yaw,float foc_len,ushort img_idx,byte target_system,byte cam_idx,/*CAMERA_FEEDBACK_FLAGS*/byte flags) 
        {
              this.time_usec = time_usec;
              this.lat = lat;
              this.lng = lng;
    ...
    {
        public mavlink_ekf_status_report_t(float velocity_variance,float pos_horiz_variance,float pos_vert_variance,float compass_variance,float terrain_alt_variance,/*EKF_STATUS_FLAGS*/ushort flags) 
        {
